...
do
	...
	sphinx-apidoc -o docs/developer energy_scan_step
...
<html>
   <head>
      <title>Documentation for the Energy Scan plug-in for SEAMM</title>
   </head>
   <body>
      <h1>Documentation for the Energy Scan plug-in for SEAMM</h1>
      <h2>Branches</h2>
      <ul>
EOF
