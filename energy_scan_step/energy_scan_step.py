...
class EnergyScanStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the Energy Scan step. It must be
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return energy_scan_step.EnergyScan(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return energy_scan_step.TkEnergyScan(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return EnergyScanStep.my_description
